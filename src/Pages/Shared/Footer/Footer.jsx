    ...
    <div>
      <footer className="footer p-10 bg-base-200 text-base-content">
        <div>
          ...
          <p>Providing reliable learn Language platform since 1992</p>
          <p>Copyright © 2023 - All right reserved by Language Camp</p>
        </div>
        <div>
          ...
          <a className="link link-hover">Korean</a>
        </div>
        <div>
          <span className="footer-title">Language Camp</span>
